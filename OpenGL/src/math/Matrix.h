...
public:
	...
	{
		// Identity matrix
	//	m_matrix[0][0] = T(1);	m_matrix[1][0] = T(0);	m_matrix[2][0] = T(0);	m_matrix[3][0] = T(0);
	//	m_matrix[0][1] = T(0);	m_matrix[1][1] = T(1);	m_matrix[2][1] = T(0);	m_matrix[3][1] = T(0);
	//	m_matrix[0][2] = T(0);	m_matrix[1][2] = T(0);	m_matrix[2][2] = T(1);	m_matrix[3][2] = T(0);
